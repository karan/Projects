...
It is required that any changes made to the projects (this does not include adding solutions) in *README.md*, must be reflected in *README-scratch.md*, in *README.md* file in the *relevant category folder* andin the [Solutions README file](https://github.com/thekarangoel/Projects-Solutions/blob/master/README.md)
