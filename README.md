...
**First Non Repeated Character** - Enter a string and the program will print out the first non repeated character of the string.
...
**Remove Specifieds Characters** - Enter a string and characters which you want to delete from string, and the program will print out the string without those characters.
